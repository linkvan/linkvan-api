...
# rubocop:disable Metrics/AbcSize, Metrics/PerceivedComplexity, Naming/PredicateMethod, RSpec/Output
def test_client
  ...
  filtered_response = client.get_dataset_records("drinking-fountains",
                                                 ...
                                                 order_by: "name asc",
                                                 limit: 5)
  if filtered_response.success? && filtered_response.body["results"].all? { |r| r.keys.sort == %w[location mapid name] }
...
# rubocop:enable Metrics/AbcSize, Metrics/PerceivedComplexity, Naming/PredicateMethod, RSpec/Output
